...
(function ($) {
    ...
    /*--------------------------------
     01. Vertical Navbar Menu
     ----------------------------------*/
    $(".vertical-navbar-menu li").click(function (e) {
        e.preventDefault();
        $(this).siblings('li.active').removeClass("active");
        $(this).addClass("active");
        var index = $(this).index();
        $(".card-inner").removeClass("active");
        $(".card-inner").eq(index).addClass("active");
    });

    $('.main-wrapper').on('click', '.home-btn', function () {
        $('.navbar li a[href="#home"]').trigger('click');
    });
    $('.main-wrapper').on('click', '.about-btn', function () {
        $('.navbar li a[href="#about"]').trigger('click');
    });
    $('.main-wrapper').on('click', '.service-btn', function () {
        $('.navbar li a[href="#services"]').trigger('click');
    });
    $('.main-wrapper').on('click', '.portfolio-btn', function () {
        $('.navbar li a[href="#portfolio"]').trigger('click');
    });
    $('.main-wrapper').on('click', '.blog-btn', function () {
        $('.navbar li a[href="#blog"]').trigger('click');
    });
